...
test('VTable: scalar echo \u2014 all types round-trip (same-thread)', () => {
  ...
  assert.strictEqual(nm.uniffi_test_fn_echo_i16_via_vtable(1n, -32768, s()), -32768);
  assert.strictEqual(nm.uniffi_test_fn_echo_i16_via_vtable(1n, 32767, s()), 32767);
  ...
  assert.strictEqual(nm.uniffi_test_fn_echo_i32_via_vtable(1n, -2147483648, s()), -2147483648);
  ...
  assert.strictEqual(nm.uniffi_test_fn_echo_f64_via_vtable(1n, -0, s()), -0);
  assert.strictEqual(nm.uniffi_test_fn_echo_f64_via_vtable(1n, Number.MAX_SAFE_INTEGER, s()), Number.MAX_SAFE_INTEGER);
});
